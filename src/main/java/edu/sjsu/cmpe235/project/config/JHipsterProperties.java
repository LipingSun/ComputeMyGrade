package edu.sjsu.cmpe235.project.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ComputeMyGrade@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ComputeMyGrade API";

        private String description = "ComputeMyGrade API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ComputeMyGrade";
