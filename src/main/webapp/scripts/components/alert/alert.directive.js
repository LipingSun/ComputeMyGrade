        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('computeMyGradeApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-computeMyGradeApp-error');
                                var entityKey = httpResponse.headers('X-computeMyGradeApp-params');
                                if (errorHeader) {
